...
**Note: Options 1 and 2 definitely work. I am new to using Docker but I believe Option 3 works as the Docker image is currently in a [public repo](https://hub.docker.com/r/amp555/flask-fetch) on Docker Hub.

Your browser should display the following program:
